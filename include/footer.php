    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="nav">
                ...
                <ul>
                    <li>
                        <a href="'.SITEURL.'services/identity-access-management/">Identity &amp; Access Management</a>
                    </li>
                    <li>
                        <a href="'.SITEURL.'services/expert-as-a-service/">Expert as Services</a>
                    </li>
                    <li>
                        <a href="'.SITEURL.'services/devops-cloud-and-automation/">DevOps Cloud &amp; Automation</a>
                    </li>
                    <li>
