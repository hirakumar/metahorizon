...
<?php 
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1>About Us</h1>
                    <div class="bread">
                        <?php  echo '<a href="'.SITEURL.'">Home</a> &gt; About Us'  ?>
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-sm-12 contCol">
                    ...
                    <p>
                        ...
                        group of people delivering business results. Metahorizon has become a premier provider of
                        information technology while creating a dynamic culture based on pushing the boundaries of
                        innovation to its top. Our long-term relationships with our customers has given us in-depth
                        knowledge of their business when leveraged with our technical expertise gives us the ability to
                        live up to their expectation and standards.
                    </p>
    ...
    <div class="wedo core">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h2>Metahorizon Core Values</h2>
                    <p class="desc">We are proud of the fact that throughout our growth, we have maintained the company
                        culture that our founding members created and instilled and that is still reflected in each
                        aspect of what we do today
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-sm-12 contCol">
                    ...
                    <p>
                        ...
                        to deliver an unparalleled customer experience. With this commitment, we will deliver a level of
                ...
                <div class="col-md-5 col-sm-12 contCol ">
                    ...
                    <p>
                        ...
                        To embody a values-driven entrepreneurial and high-performance culture in our employees. To
                        develop our communities into self-sustaining, technology-enabled ecosystems.
                    </p>
                    <h3>To Our Employees</h3>
                    <p>
                        To promote a culture in which we celebrate, have fun, and recognize those that work hard, help
                        others be successful, and who deliver creative, unique, and unexpected experiences to our
                        customers. We empower our employees to be leaders on day one. We are committed to being great at
                        open and honest communication with our employees. We value professional development plans in
                        support of individual and company goals. We invest in providing tools, training and experiences
                        necessary to grow personally and professionally.
                    </p>
                    <h3>To Our Community</h3>
                    <p>At Metahorizon, we feel it is our responsibility to be a part of the community in which we live.
                ...
                <div class="col-md-5 col-sm-12 contCol align-right offset-md-1">
                    ...
                    <div class="smallLinks"><a href="#">Go Top</a></div>
                </div>
            </div>
        </div>
    </div>
